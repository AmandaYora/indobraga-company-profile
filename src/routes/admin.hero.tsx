      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <div className="space-y-4">
            <Field
              label="Judul Utama"
              value="Solusi Produksi Garment Profesional untuk Bisnis Anda"
            />
            <Field
              label="Subjudul"
              textarea
              value="Apparel manufacturing, brand development, custom fabric printing, dan multiproduct facility untuk kebutuhan bisnis."
            />
