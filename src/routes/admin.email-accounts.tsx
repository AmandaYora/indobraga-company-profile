...
const accounts = [
  {
    ...
    name: "Marketing",
    status: "connected",
    at: "Terhubung 2 minggu lalu",
  },
  {
    email: "info@indobraga.co.id",
    name: "Info",
    status: "connected",
    at: "Terhubung 1 bulan lalu",
  },
  {
    email: "promo@indobraga.co.id",
    name: "Promo",
    status: "expired",
    at: "Perlu dihubungkan ulang",
  },
];
        ...
        {accounts.map((a) => (
          <Card key={a.email}>
            ...
            <div className="mt-4 flex gap-2">
              <button className="inline-flex items-center gap-1 rounded-md border border-border px-3 py-1.5 text-xs font-semibold hover:bg-secondary">
                <RefreshCw className="h-3.5 w-3.5" /> Hubungkan Ulang
              </button>
              <button className="inline-flex items-center gap-1 rounded-md border border-border px-3 py-1.5 text-xs font-semibold text-destructive hover:bg-destructive/10">
